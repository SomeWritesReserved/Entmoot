namespace Entmoot.Debug.NetTestWinForms
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.serverGroupBox = new Entmoot.Debug.NetTestWinForms.DoubleBufferedGroupBox();
			this.clientGroupBox = new Entmoot.Debug.NetTestWinForms.DoubleBufferedGroupBox();
			...
			this.clientPacketTimelineDisplay = new Entmoot.Debug.NetTestWinForms.PacketTimelineDisplay();
			...
			this.clientPacketTimelineDisplay.ClientServerContext = Entmoot.Debug.NetTestWinForms.ClientServerContext.Client;
